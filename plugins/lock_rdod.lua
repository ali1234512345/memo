...
elseif w== 'شكو ماكو'  then-- by @dev_iraq1
...
elseif w== 'واكف'  then
tdcli.sendMessage(msg.chat_id_, 0, 1, 'يخي مابيه شي ليش تتفاول😢', 1, 'html')
...
tdcli.sendMessage(msg.chat_id_, 0, 1, 'مطوريني يعني تاج راسي @dev_iraq1', 1, 'html')
elseif w== 'اريد بوت'  then
tdcli.sendMessage(msg.chat_id_, 0, 1, 'تعال لتستحي اطلب منهم @dev_iraq1', 1, 'html')
